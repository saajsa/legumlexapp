...
class CasesDashboardScreen extends StatefulWidget {
  const CasesDashboardScreen({super.key});

  @override
  State<CasesDashboardScreen> createState() => _CasesDashboardScreenState();
}

class _CasesDashboardScreenState extends State<CasesDashboardScreen> {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: _buildProjectPreview(index),
                );
              },
            ),
          ),
  ...
  Widget _buildProjectPreview(int index) {
    final projects = [
      {
  ...
  Widget _buildInvoicePreview(int index) {
    final invoices = [
      {
        'number': 'INV-2024-001',
        'client': 'Smith Corporation',
